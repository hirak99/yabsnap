...
def _deleted_times(rules: dict[int, int], records: list[int]):
  ...
  toscan = [
      (datetime.datetime.fromtimestamp(nowts + x), str(x)) for x in records
  ]
  return [
  ...
  def test_multi_rule(self):
    self.assertEqual(
        _deleted_times({
            100: 0,
            10: 0
        }, [-115, -105, -25, -15, -5]), [-115, -105, -25, -15, -5])
    self.assertEqual(
        _deleted_times({
            100: 0,
            10: 2
        }, [-115, -105, -25, -15, -5]), [-115, -105, -25])
    self.assertEqual(
        _deleted_times({
            100: 0,
            10: 3
        }, [-115, -105, -25, -15, -5]), [-115, -105])
    self.assertEqual(
        _deleted_times({
            100: 0,
            10: 4
    ...
    self.assertEqual(_deleted_times({
        100: 2,
        10: 0
    }, [-115, -25, -15, -5]), [-15, -5])
    self.assertEqual(_deleted_times({
